...
"""Calculating the cumulative n-gram BLEU score for a sentence"""
...
def transform_grams(references, sentence, n):
    """Transforming references and sentence based on grams"""
    if n == 1:
...
def precision(references, sentence, n):
    """
    Calculating the precision for n-gram BLEU score for a sentence
    """
